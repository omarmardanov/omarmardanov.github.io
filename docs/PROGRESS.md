...
- Гайд для контент-команды собран в Notion-импорт бандл (`docs/notion-import.zip`, 17 страниц с примерами).
...
1. **Решение по CMS** от директора (WP или Directus) → дальше разный путь внедрения, ~3–4 нед на WP силами текущей команды, ~4–6 нед на Directus с разовым подрядчиком.
2. **WP-разработчику создать 10 страниц-услуг** по шаблону `uslugi-shablon/` под slugs (если решение — WordPress):
   ...
   Контент готовит команда заказчика по шаблону `docs/content-templates/03-spetsializatsiya.md`.
3. **Заполнение контентом** по шаблонам Notion — команда заказчика начинает после онбординга по `docs/notion-import.zip`.
4. **Заполнить плейсхолдеры контактов** в Notion-странице «Процесс и контакты» (редактор сайта, юристы-предметники, партнёр для согласования кейсов, WP-разработчик).
